...
namespace REX.Serialization
{
    ...
    internal class Extension : REXExtension
    {
        ...
        public override void OnCreateLayout()
        {
            ...
            Layout.ConstOptions |= (long)REXUI.SetupOptions.TabDialog;

            Layout.AddLayout(new REXLayoutItem(REXLayoutItem.LayoutType.Layout, "Layout", "", "Layout", (long)0, SubControlRef, null, 0));
